...
def build_transformer(args): 
    ...
    return Transformer(
        d_model=args["NN"]["hidden_dim"], 
        dropout=args["NN"]["dropout"],
        nhead=args["NN"]["nheads"],
        dim_feedforward=args["NN"]["dim_feedforward"],
        num_encoder_layers=args["NN"]["enc_layers"],
        num_decoder_layers=args["NN"]["dec_layers"],
        normalize_before=args["NN"]["pre_norm"],
